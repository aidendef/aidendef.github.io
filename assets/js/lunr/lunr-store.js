var store = [{
        "title": "첫 블로그 글",
        "excerpt":"안녕하세요   Aiden의 든든한 블로그에 와주셔서 감사합니다. 앞으로 많이 찾아와주세요 :)  ","categories": ["private","blog"],
        "tags": ["blog"],
        ...
        "excerpt":"0. 앞서보는 3줄 결론 GCP는 AI/ML, 데이터 분석에 강하고, AWS는 서비스 다양성과 기업 클라우드에 최적화되어 있습니다. ➡ GCP는 AI 연구·개발용 클라우드, AWS는 기업용 AI 솔루션 클라우드입니다. 1. 출발점과 강점 비교 항목 GCP (Google Cloud Platform) AWS (Amazon Web Services) 출발 배경 구글 내부 인프라 기반 아마존 전자상거래 인프라 기반 강점...","categories": ["cloud","ai"],
        "tags": ["GCP","AWS","AI","클라우드비교"],
        "url": "/cloud/ai/GCPvsAWS%EB%B9%84%EA%B5%90/",
        ...
        "excerpt":"1. 들어가며 최근 다양한 기업들이 사내 문서 기반 지식 검색 시스템, 즉 RAG(Retrieval-Augmented Generation) 기반의 챗봇을 도입하고 있다. [Gartner 보고서 보기, Accenture AI 인사이트, McKinsey: 생성형 AI의 경제적 잠재력, AWS GenAI 공개 고객 사례집] 특히 AWS Bedrock은 Amazon Titan, Claude, Command 등을 통합 제공하며, LLM 기반 지식 응답 시스템을 완전관리형으로...","categories": ["cloud","ai","Business"],
        "tags": ["AWS","AI","Bedrock","RAG","Retrieval-Augmented Generation","LLM","Knowledge Base","지식기반"],
        "url": "/cloud/ai/business/AWS-Bedrock-%EC%A7%80%EC%8B%9D%EA%B8%B0%EB%B0%98%EC%9D%84-A-to-Z-%EB%AA%A8%EB%91%90-%EA%B5%AC%ED%98%84%ED%95%B4%EB%B3%B4%EA%B8%B0/",
        "teaser": "/assets/images/post_img/Knowledge-Bases-feat-img.png"
      },{
        "title": "이쁨 받는 AWS 아키텍처 만들어보자",
        "excerpt":"1. 들어가며 클라우드 환경에서의 아키텍처 설계는 단순히 서비스를 배치하는 것을 넘어, 확장성, 안정성, 비용 효율성까지 고려한 종합 설계이다. 하지만 처음 시작할 때는 수많은 AWS 서비스들 사이에서 무엇을 선택해야 할지, 어떻게 조합해야 할지 막막할 수밖에 없다. 이 글에서는 복잡한 이론 대신, 실제 현업에서도 이쁨(?) 받는 AWS 아키텍처를 만드는 실전 방식을 공유하려고...","categories": ["cloud"],
        "tags": ["AWS","AI","Bedrock","Sagemaker","Architecture","Cloud","보안"],
        "url": "/cloud/%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%EC%9D%98-%EA%B8%B0%EC%B4%88-AWS-%EC%95%84%ED%82%A4%ED%85%8D%EC%B2%98-%EB%A7%8C%EB%93%A4%EC%96%B4%EB%B3%B4%EC%9E%90/",
        ...
        "title": "aws자격증 취득",
        "excerpt":"1. 왜 이 논문을 알아야하나? 얼마나 중요한가? Future of Work with AI Agents 라는 논문을 읽고 아래 간략하게 작성을 진행할 것이다. 긴글을 읽기 앞서 왜 우리는 이 글을 봐야하는지 설명을 진행할 것이다. AI가 인간 노동을 대체할 것이라는 통념의 재검토 최근 AI, 특히 생성형 AI와 에이전트 시스템의 발전은 “AI가 인간의 일을...","categories": ["ai","cloud"],
        "tags": ["Human-Centric AI","AI Collaboration","Future of Work","Human Agency","Augmentation over Automation","Future of Work with AI Agents"],
        "url": "/ai/cloud/aws%EC%9E%90%EA%B2%A9%EC%A6%9D-%EC%B7%A8%EB%93%9D/",
        "teaser": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeDV5OXFubHBnZ252ZGt6d21hcnVzZjNpZ21lN2UzdWc0MDBsdTFjbCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/ABVK96HgZvWI9SBbXr/giphy.gif"
      }]
